...
public class SubsResource {
    ...
    public SubsResource(String access_token) {
        this.access_token = access_token;
    }
    
    public SubcribersSearch getSubcribers(String query) throws UnsupportedEncodingException {
        String queryFormatted = URLEncoder.encode(query, "UTF-8");
        String uri = "https://api.twitch.tv/helix/subscriptions" + "?broadcaster_id=" + queryFormatted;
        log.log(Level.FINE, "URI: " + uri);
        
        ClientResource cr = null;
        SubcribersSearch SubsSearch = null;
        try {
            ...
            SubsSearch = cr.get(SubcribersSearch.class);
            
        }catch (ResourceException re) {
    		System.err.println("Error getting subcriptions; " + cr.getResponse().getStatus());
			throw re;
		}
